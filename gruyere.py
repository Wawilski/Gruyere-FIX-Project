...
def main():
    ...
    global http_server
    http_server = HTTPServer((server_name, server_port), GruyereRequestHandler)
...
def _LoadDatabase():
    ...
    f = _Open(INSTALL_PATH, SECRET_FILE, "r")
...
class GruyereRequestHandler(BaseHTTPRequestHandler):
    ...
    def _getValidUrls():
        ...
        # urls = []
        # for method in dir(GruyereRequestHandler):
        #     if callable(getattr(GruyereRequestHandler, method)) and method.startswith(
        #         "_Do"
        #     ):
        #         urls.append(method[len("_DO") :])
        print(urls)
        return urls
    ...
    def _DoHome(self, cookie, specials, params, new_cookie_text=None):
        ...
        self._SendTemplateResponse("/home.gtl", specials, params, new_cookie_text)
    ...
    def _SendTemplateResponse(self, filename, specials, params, new_cookie_text=None):
        ...
        self._SendHtmlResponse(
            gtl.ExpandTemplate(template, specials, params), new_cookie_text
        )
    ...
    def _SendFileResponse(self, filename, cookie, specials, params):
        ...
        if "." not in extension:
            ...
            self._SendError(
                "Unrecognized file type (%s)." % (filename,), cookie, specials, params
            )
            return
        f = None
        try:
    ...
    def _SendError(self, message, cookie, specials, params, new_cookie_text=None):
        ...
        """
        specials["_message"] = message
        self._SendTemplateResponse("/error.gtl", specials, params, new_cookie_text)
    ...
    def _SendRedirect(self, url, unique_id):
        ...
        self.send_header("X-XSS-Protection", "0")
        self.end_headers()
        res = """<!DOCTYPE HTML PUBLIC '-//W3C//DTD HTML//EN'>
        <html><body>
    ...
    def DoGetOrPost(self):
        ...
        if (
            ...
            # else:                                                  # DO NOT CHANGE
            #   print((                                # DO NOT CHANGE
            #       'DANGER! Request without unique id: ' + path), file=sys.stderr)    # DO NOT CHANGE
